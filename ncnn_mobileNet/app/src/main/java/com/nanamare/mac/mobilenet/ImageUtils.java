...
public class ImageUtils {
     ...
     */
    public static void customSaveBitmap(final Bitmap bitmap, final String label) {
        fireSaveBitmap(bitmap, System.currentTimeMillis() + "preview.png", label);
    }
     ...
     */
    public static void fireSaveBitmap(Bitmap bitmap, final String filename, final String label) {
        final String root =
                Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + label;
...
//    bitmap = GetRotatedBitmap(bitmap, 90);
    ...
    public static void saveBitmap(final Bitmap bitmap) {
        saveBitmap(bitmap, System.currentTimeMillis() + "preview.jpg");
        saveBitmap(bitmap, System.currentTimeMillis() + "preview2.png",0);
    }
    ...
    public static void saveBitmap(Bitmap bitmap, final String filename) {
        final String root =
                Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "video_player";
        LOGGER.i("Saving %dx%d bitmap to %s.", bitmap.getWidth(), bitmap.getHeight(), root);
...
//    bitmap = GetRotatedBitmap(bitmap, 90);
    ...
    public static void saveBitmap(Bitmap bitmap, final String filename, int a) {
        final String root =
                Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "video_player";
        LOGGER.i("Saving %dx%d bitmap to %s.", bitmap.getWidth(), bitmap.getHeight(), root);
